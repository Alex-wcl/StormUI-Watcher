...
public class VariableServlet extends HttpServlet{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		variables.setDataProcessorSleepTime(DataProcessorSleepTime);
		variables.setDataSourceServerIP(DataSourceServerIP);
		variables.setDataSourceServerPort(DataSourceServerPort);
		variables.setDataBaseServerIP(DataBaseServerIP);
		variables.setDataBaseServerPort(DataBaseServerPort);
		variables.setDataBaseUserName(DataBaseUserName);
		variables.setDataBasePassword(DataBasePassword);
		variables.setDataBaseName(DataBaseName);
		req.setAttribute("variables", variables);
